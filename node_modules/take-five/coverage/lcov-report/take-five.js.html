...
<html lang="en">
<head>
    <title>Code coverage report for take-five.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> take-five.js
    </h1>
    <div class='clearfix'>
...
<a name='L270'></a><a href='#L270'>270</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
  parseBody (req, res, ctx) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!res.finished) {
      try {
...
&nbsp;
<span class="fstat-no" title="function not covered" >  ha</span>ndleError (err, req, res, ctx) { // eslint-disable-line
  }
&nbsp;
  cors (res) {
...
&nbsp;
  _handleRequest (req, res, ctx) {
    try {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (res.finished) {
...
&nbsp;
    function iterate (handler) {
      const done = (value) =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (value instanceof Error) {
<span class="cstat-no" title="statement not covered" >          return this.handleError(value, req, res, ctx)</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            this.handleError(err, req, res, ctx)</span>
          })
      }
    }
  }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Mar 28 2018 10:34:03 GMT-0700 (PDT)
</div>
</div>
